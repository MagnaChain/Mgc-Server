...
Insight.prototype.getUtxos = function(addresses, cb, walletId) {
  log.debug("##################### Insight.prototype.getUtxos");
  var self = this; 
...
Insight.prototype.broadcast = function(rawTx, cb) {
  log.debug("##################### Insight.prototype.broadcast rawTx: " + JSON.stringify(rawTx) );
  var args = {
    method: 'POST',
...
Insight.prototype.getTransaction = function(txid, cb) {
  log.debug("##################### Insight.prototype.getTransaction txid: " + txid );
  var self = this;
  var args = {
    method: 'GET',
...
Insight.prototype.getTransactions = function(addresses, from, to, cb, walletId) {
  log.debug("##################### Insight.prototype.getTransactions addresses: " + JSON.stringify(addresses) );
  var self = this;
...
Insight.prototype.getAddressActivity = function(address, cb) {
  log.debug("##################### Insight.prototype.getAddressActivity address: " + JSON.stringify(address) );
  var self = this;
...
Insight.prototype.estimateFee = function(nbBlocks, cb) {
  log.debug("##################### Insight.prototype.estimateFee nbBlocks: " + JSON.stringify(nbBlocks) );
...
Insight.prototype.getBlockchainHeight = function(cb) {
  log.debug("##################### Insight.prototype.getBlockchainHeight" );
...
Insight.prototype.getTxidsInBlock = function(blockHash, cb) {
  log.debug("##################### Insight.prototype.getTxidsInBlock" );
  var self = this;
