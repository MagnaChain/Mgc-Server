...
WalletService.handleIncomingNotification = function(notification, cb) {
  log.debug("WalletService.handleIncomingNotification " );
  cb = cb || function() {};
...
WalletService.prototype.login = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.login");
  var session;
  async.series([
...
WalletService.prototype.logout = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.logout");
...
WalletService.prototype.getWallet = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getWallet");
...
WalletService.prototype.getWalletFromIdentifier = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getWalletFromIdentifier");
...
WalletService.prototype.getStatus = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getStatus opts：" + JSON.stringify(opts) );
  opts = opts || {};
  ...
  async.parallel([
    ...
    function(next) {
      self.getWallet({}, function(err, wallet) {
        if (err) return next(err);
        self.logi("WalletService.prototype.getStatus get the wallet");
    ...
    function(next) {
      self.getBalance(opts, function(err, balance) {
        if (err) return next(err);
		self.logi("WalletService.prototype.getStatus get the balance");
    ...
    function(next) {
      self.getPendingTxs({}, function(err, pendingTxps) {
        if (err) return next(err);
		self.logi("WalletService.prototype.getStatus get the pendingTxps");
    ...
    function(next) {
      self.getPreferences({}, function(err, preferences) {
        if (err) return next(err);
		self.logi("WalletService.prototype.getStatus get the preferences");
...
WalletService.prototype._verifySignature = function(text, signature, pubkey) {
  //self.logi("WalletService.prototype._verifySignature");
...
WalletService.prototype._verifyRequestPubKey = function(requestPubKey, signature, xPubKey) {
  //self.logi("WalletService.prototype._verifyRequestPubKey");
...
WalletService.prototype._getSigningKey = function(text, signature, pubKeys) {
  var self = this;
  self.logi("WalletService.prototype._getSigningKey");
...
WalletService.prototype._notify = function(type, data, opts, cb) {
  var self = this;
  self.logi("WalletService.prototype._notify");
...
WalletService.prototype._notifyTxProposalAction = function(type, txp, extraArgs, cb) {
  var self = this;
  self.logi("WalletService.prototype._notifyTxProposalAction");
...
WalletService.prototype._addCopayerToWallet = function(wallet, opts, cb) {
  var self = this;
  self.logi("WalletService.prototype._addCopayerToWallet");
  ...
  self.storage.fetchCopayerLookup(copayer.id, function(err, res) {
	self.logi("WalletService.prototype.fetchCopayerLookup");
    if (err) return cb(err);
...
WalletService.prototype._addKeyToCopayer = function(wallet, copayer, opts, cb) {
  var self = this;
  self.logi("WalletService.prototype._addKeyToCopayer");
...
WalletService.prototype.addAccess = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.addAccess");
...
WalletService.prototype._setClientVersion = function(version) {
  //log.debug("WalletService.prototype._setClientVersion");
  delete this.parsedClientVersion;
  this.clientVersion = version;
};

WalletService.prototype._parseClientVersion = function() {
  log.debug("WalletService.prototype._parseClientVersion");
...
WalletService.prototype._clientSupportsPayProRefund = function() {
  log.debug("WalletService.prototype._clientSupportsPayProRefund");
...
WalletService._getCopayerHash = function(name, xPubKey, requestPubKey) {
  log.debug("WalletService.prototype._getCopayerHash");
...
WalletService.prototype.joinWallet = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.joinWallet");
...
WalletService.prototype.savePreferences = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.savePreferences");
...
WalletService.prototype.getPreferences = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getPreferences");
...
WalletService.prototype._canCreateAddress = function(ignoreMaxGap, cb) {
  var self = this;
  self.logi("WalletService.prototype._canCreateAddress");
...
WalletService.prototype.createAddress = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.createAddress");
...
WalletService.prototype.getMainAddresses = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getMainAddresses");
...
WalletService.prototype.verifyMessageSignature = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.verifyMessageSignature");
...
WalletService.prototype._getBlockchainExplorer = function(coin, network) {
  log.debug("WalletService.prototype._getBlockchainExplorer");
  var opts = {};
...
WalletService.prototype._getUtxos = function(coin, addresses, cb) {
  var self = this;
  self.logi("WalletService.prototype._getUtxos");
...
WalletService.prototype._getUtxosForCurrentWallet = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype._getUtxosForCurrentWallet");
...
WalletService.prototype.getUtxos = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getUtxos");
...
WalletService.prototype._totalizeUtxos = function(utxos) {
  log.debug("WalletService.prototype._totalizeUtxos");
  var balance = {
...
WalletService.prototype._getBalanceFromAddresses = function(opts, cb, i) {
  var self = this;
  self.logi("WalletService.prototype._getBalanceFromAddresses opts: " + JSON.stringify(opts) );
...
WalletService.prototype._getBalanceOneStep = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype._getBalanceOneStep opts: " + JSON.stringify(opts) );
...
WalletService.prototype._getActiveAddresses = function(cb) {
  var self = this;
  self.logi("WalletService.prototype._getActiveAddresses");
...
WalletService.prototype._checkAndUpdateAddressCount = function(twoStepCache, cb) {
  var self = this;
  self.logi("WalletService.prototype._checkAndUpdateAddressCount twoStepCache: " + JSON.stringify(twoStepCache) );
  ...
  self.storage.countAddresses(self.walletId, function(err, addressCount) {
    if (err) return cb(err);
    log.debug("WalletService.prototype._checkAndUpdateAddressCount addressCount: " + addressCount );
...
WalletService.prototype.getBalance = function(opts, cb, i) {
  var self = this;
  self.logi("WalletService.prototype.getBalance opts: " + JSON.stringify(opts) );
  ...
  if (!opts.twoStep) {
	log.debug("WalletService.prototype.getBalance one step ");
  ...
  self.storage.getTwoStepCache(self.walletId, function(err, twoStepCache) {
    ...
    self._checkAndUpdateAddressCount(twoStepCache, function(err, needsTwoStep ) {
      ...
      if (!needsTwoStep) {
		log.debug("WalletService.prototype.getBalance needsTwoStep is false call _getBalanceOneStep ");
        return self._getBalanceOneStep(opts, cb);
      }
...
WalletService.prototype.getSendMaxInfo = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getSendMaxInfo");
...
WalletService.prototype._sampleFeeLevels = function(coin, network, points, cb) {
  var self = this;
  self.logi("WalletService.prototype._sampleFeeLevels");
...
WalletService.prototype.getFeeLevels = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getFeeLevels");
...
WalletService.prototype._estimateFee = function(txp) {
  log.debug("WalletService.prototype._estimateFee");
  txp.estimateFee();
};

WalletService.prototype._checkTx = function(txp) {
  var self = this;
  self.logi("WalletService.prototype._checkTx");
...
WalletService.prototype._selectTxInputs = function(txp, utxosToExclude, cb) {
  var self = this;
  self.logi("WalletService.prototype._selectTxInputs");
...
WalletService.prototype._canCreateTx = function(cb) {
  var self = this;
  self.logi("WalletService.prototype._canCreateTx");
...
WalletService.prototype._validateOutputs = function(opts, wallet, cb) {
  log.debug("WalletService.prototype._validateOutputs");
...
WalletService.prototype._validateAndSanitizeTxOpts = function(wallet, opts, cb) {
  var self = this;
  self.logi("WalletService.prototype._validateAndSanitizeTxOpts");
...
WalletService.prototype._getFeePerKb = function(wallet, opts, cb) {
  var self = this;
  self.logi("WalletService.prototype._getFeePerKb");
...
WalletService.prototype.createTx = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.createTx");
...
WalletService.prototype._verifyRequestPubKey = function(requestPubKey, signature, xPubKey) {
  log.debug("WalletService.prototype._verifyRequestPubKey");
  var pub = (new Bitcore.HDPublicKey(xPubKey)).deriveChild(Constants.PATHS.REQUEST_KEY_AUTH).publicKey;
  return Utils.verifyMessage(requestPubKey, signature, pub.toString());
};
...
WalletService.prototype.publishTx = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.publishTx");
...
WalletService.prototype.getTx = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getTx");
...
WalletService.prototype.editTxNote = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.editTxNote");
...
WalletService.prototype.getTxNote = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getTxNote");
...
WalletService.prototype.getTxNotes = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getTxNotes");
...
WalletService.prototype.removeWallet = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.removeWallet");
...
WalletService.prototype.getRemainingDeleteLockTime = function(txp) {
  log.debug("WalletService.prototype.getRemainingDeleteLockTime");
  var now = Math.floor(Date.now() / 1000);
...
WalletService.prototype.removePendingTx = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.removePendingTx");
...
WalletService.prototype._broadcastRawTx = function(coin, network, raw, cb) {
  log.debug("WalletService.prototype._broadcastRawTx");
...
WalletService.prototype.broadcastRawTx = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.broadcastRawTx");
...
WalletService.prototype._checkTxInBlockchain = function(txp, cb) {
  log.debug("WalletService.prototype._checkTxInBlockchain");
...
WalletService.prototype.signTx = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.signTx");
...
WalletService.prototype._processBroadcast = function(txp, opts, cb) {
  var self = this;
  self.logi("WalletService.prototype._processBroadcast");
...
WalletService.prototype.broadcastTx = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.broadcastTx");
...
WalletService.prototype.rejectTx = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.rejectTx");
...
WalletService.prototype.getPendingTxs = function(opts, cb) { 
  var self = this;	
  self.logi("WalletService.prototype.getPendingTxs");
...
WalletService.prototype.getTxs = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getTxs");
...
WalletService.prototype.getNotifications = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getNotifications");
...
WalletService.prototype._normalizeTxHistory = function(txs) {
  log.debug("WalletService.prototype._normalizeTxHistory");
  var now = Math.floor(Date.now() / 1000);
...
WalletService._initBlockchainHeightCache = function() {
  //log.debug("WalletService._initBlockchainHeightCache");
...
WalletService._clearBlockchainHeightCache = function(coin, network) {
  //log.debug("WalletService._clearBlockchainHeightCache");
...
WalletService.prototype._getBlockchainHeight = function(coin, network, cb) {
  var self = this;
  self.logi("WalletService.prototype._getBlockchainHeight");
...
WalletService.prototype.getTxHistory = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getTxHistory");
...
WalletService.prototype.scan = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.scan");
...
WalletService.prototype.startScan = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.startScan");
...
WalletService.prototype.getFiatRate = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.getFiatRate");
...
WalletService.prototype.pushNotificationsSubscribe = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.pushNotificationsSubscribe");
...
WalletService.prototype.pushNotificationsUnsubscribe = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.pushNotificationsUnsubscribe");
  if (!checkRequired(opts, ['token'], cb)) return;
...
WalletService.prototype.txConfirmationSubscribe = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.txConfirmationSubscribe");
  if (!checkRequired(opts, ['txid'], cb)) return;
...
WalletService.prototype.txConfirmationUnsubscribe = function(opts, cb) {
  var self = this;
  self.logi("WalletService.prototype.txConfirmationUnsubscribe");
  if (!checkRequired(opts, ['txid'], cb)) return;
